...
def get_valid_filename(msg):
    ...
    # Prompt user to input correct filename. If filename exists in the 
    # specified path, then end loop of prompt.
...
def get_valid_directory_name(msg):
    ...
    # Prompt user to input correct directory of signature files. If directory 
    # exists in the specified path, then end loop of prompt.    
